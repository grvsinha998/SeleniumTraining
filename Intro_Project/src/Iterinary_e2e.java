...
public class Iterinary_e2e {
	...
	static void Discount(String discount, WebDriver driver) throws InterruptedException
	{
		
		String disc_text = " " + discount;
		StringBuffer xpath = new StringBuffer("//div[@id='discount-checkbox']/div/label[text()='']");
		xpath.insert(49, disc_text);
		String new_xpath = xpath.toString();
		
		driver.findElement(By.id("discount-checkbox")).getSize();
		driver.findElement(By.xpath(new_xpath)).click();
		Thread.sleep(1000);
